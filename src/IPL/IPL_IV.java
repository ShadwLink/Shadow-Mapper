...
public class IPL_IV {
    ...
    public void readHeader(ReadFunctions rf){
        ...
        System.out.println(grge);
        System.out.println(cars);
        System.out.println(cull);
        System.out.println(unused2);
        System.out.println(unused3);
        System.out.println(unused4);
        System.out.println(strbig);
        System.out.println(lcul);
        System.out.println(zone);
        System.out.println(unused5);
        System.out.println(unused6);
        System.out.println(unused7);
        System.out.println(unused8);
    ...
    public void writeHeader(WriteFunctions wf, IPL wpl){
        wf.writeInt(3);
        wf.writeInt(wpl.items_inst.size());
        wf.writeInt(0);
        wf.writeInt(wpl.items_grge.size());
        wf.writeInt(wpl.items_cars.size());
        wf.writeInt(wpl.items_cull.size());
        wf.writeInt(0);
        wf.writeInt(0);
        wf.writeInt(0);
        wf.writeInt(strbig); //temp
        wf.writeInt(lcul); //temp
        wf.writeInt(zone); //temp
        wf.writeInt(0);
        wf.writeInt(0);
        wf.writeInt(0);
        wf.writeInt(0);
        wf.writeInt(blok); //temp        
    }
