...
public class Select extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(listGames, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jLabel1)
                .addGap(1, 1, 1)
                .addComponent(listGames, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void buttonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOKActionPerformed
        ...
        if(gameType == Finals.gIV){
            //new Main(gameDir, gameType, findKey(gameDir));//.loadGame(gameDir, gameType, findKey(gameDir));
            new LoadingBar(gameDir, gameType, findKey(gameDir));
        }else{
            //new Main(gameDir, gameType, null);//main.loadGame(gameDir, gameType, null);
        }
        this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        File file = Util.fileChooser(this, Finals.fileOpen, new Filter(extensions, "IV Install Folder (gtaIV.exe)", true));
        if(file != null && file.exists()){
            ...
            if(installName != null){
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Unable to write to ini, it might be in use by another program.");
                }
                fillGameList();
            }else{
